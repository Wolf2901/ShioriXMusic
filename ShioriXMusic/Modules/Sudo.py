...
from ShioriXMusic import BOT_NAME, OWNER_ID, SUDO_USERS, app
from ShioriXMusic.Helpers.Database import (get_active_chats, get_served_chats, remove_active_chat)
...
async def theme_func(_, message):
    ...
    os.system(f"kill -9 {os.getpid()} && python3 -m ShioriXMusic")
...
async def update(_, message):
    ...
    if str(m[0]) != "A":
        ...
        return os.system(f"kill -9 {os.getpid()} && python3 -m ShioriXMusic")
    else:
