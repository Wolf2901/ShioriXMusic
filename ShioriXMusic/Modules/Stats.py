...
from ShioriXMusic import (BOT_NAME, SUDO_USERS, app, Ass, StartTime, MONGO_DB_URI)
from ShioriXMusic.Helpers.Database import get_gbans_count, get_served_chats, get_served_users
from ShioriXMusic.Helpers.Inline import stats_f, stats_b
from ShioriXMusic.Modules import ALL_MODULES
from ShioriXMusic.Helpers.Ping import get_readable_time
...
async def gstats(_, message):
    ...
    hehe = await message.reply_photo(
        photo="ShioriXMusic/Utilities/Stats.jpeg", caption=f"**» ᴩʟᴇᴀsᴇ ᴡᴀɪᴛ...\n\n• ɢᴇᴛᴛɪɴɢ {BOT_NAME} sᴛᴀᴛs...**"
    )
    smex = f"""
